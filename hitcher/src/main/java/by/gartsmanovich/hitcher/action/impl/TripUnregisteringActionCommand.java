...
import static by.gartsmanovich.hitcher.service.exception.ServiceErrorCodes
        .INVALID_PARAMETER_VALUE;

/**
 * Class describes unregister from a trip action command.
 *
 * @author Dmitry Gartsmanovich
 */
public class TripUnregisteringActionCommand extends AuthorizedActionCommand {

    /**
     * The logger for TripUnregisteringActionCommand class.
     */
    private static final Logger LOGGER = LogManager.getLogger(
            TripUnregisteringActionCommand.class);
    ...
    public void execute(final HttpServletRequest request,
        ...
        try {
            if (tripId != null) {
                ...
                tripService.deletePassenger(user.getId(), tripId);
                LOGGER.debug("Unregister from a trip was completed"
                             + " successfully");
