...
import by.gartsmanovich.javawebdev.composite.controller.command.impl.CreateMatrixCommand;
import by.gartsmanovich.javawebdev.composite.controller.command.impl.ExecutorServiceCommand;
import by.gartsmanovich.javawebdev.composite.controller.command.impl.ExitCommand;
import by.gartsmanovich.javawebdev.composite.controller.command.impl.LockCommand;
import by.gartsmanovich.javawebdev.composite.controller.command.impl.SaveLastCommand;
import by.gartsmanovich.javawebdev.composite.controller.command.impl.SemaphoreCommand;
import by.gartsmanovich.javawebdev.composite.controller.command.impl.ThreadDistributionCommand;
import by.gartsmanovich.javawebdev.composite.controller.command.impl.WrongRequestCommand;
...
public class CommandProvider {
    ...
    public CommandProvider() {
        ...
        repository.put(CommandName.EXECUTOR_SERVICE,
                       new ExecutorServiceCommand());
