...
/**
 * Class describes the StAX Builder command that invoke appropriate method
 * from Service layer of the application.
 *
 * @author Dmitry Gartsmanovich
 */
public class StAXBuilderCommand implements Command {

    /**
     * The logger for StAXBuilderCommand class.
     */
    private static final Logger LOGGER = LogManager.getLogger(
            StAXBuilderCommand.class);
